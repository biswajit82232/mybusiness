...
export function IcEye() {
  return (
    <svg {...svgBase}>
      <path {...sw} strokeWidth="1.8" d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z" />
      <circle {...sw} strokeWidth="1.8" cx="12" cy="12" r="3" />
    </svg>
  );
}

export function IcEyeOff() {
  return (
    <svg {...svgBase}>
      <path {...sw} strokeWidth="1.8" d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94" />
      <path {...sw} strokeWidth="1.8" d="M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19" />
      <path {...sw} strokeWidth="1.8" d="M1 1l22 22" />
      <path {...sw} strokeWidth="1.8" d="M14.12 14.12a3 3 0 01-4.24-4.24" />
    </svg>
  );
}
